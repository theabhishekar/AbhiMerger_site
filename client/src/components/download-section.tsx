...
const platforms = [
  {
    id: "windows",
    name: "Windows",
    description: "Windows 7/8/10/11 (x64) • 105 MB",
    bgColor: "bg-blue-100",
    iconColor: "text-blue-600",
    downloadUrl: "https://drive.google.com/uc?export=download&id=1yWd4gXnrcx9-NpIlsf7RcEI_qMOhRWWp",
    icon: (
  ...
  },
  {
    id: "mac",
    name: "macOS",
    description: "macOS 10.12+ (Apple Silicon M1/M2/M3) • 142 MB",
    bgColor: "bg-gray-100",
    iconColor: "text-gray-600",
    downloadUrl: "https://drive.google.com/uc?export=download&id=134k7vevd2e-Cx0tl3HfDWZxPZ3aVkudL",
    icon: (
      <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    id: "linux",
    name: "Linux",
    description: "Most Linux distributions (ARM64 AppImage)",
    bgColor: "bg-orange-100",
    iconColor: "text-orange-600",
    downloadUrl: "https://drive.google.com/uc?export=download&id=1sqSzvxmnFz8b7dN-iVbUe3SlLUV3k1ec",
    icon: (
      <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
        ...
        <ScrollReveal>
          <div>
            ...
            <div className="text-sm text-muted-foreground mb-8" data-testid="system-requirements">
              System Requirements: 4GB RAM • 500MB Storage • Version 1.0.0
            </div>
